...
ActiveRecord::Schema[7.0].define(version: 2023_04_12_034342) do
  ...
  create_enum "tinder_account_status", ["banned", "shadowbanned", "verification_required", "active", "under_review", "logged_out", "captcha_required", "identity_verification", "profile_deleted", "proxy_error", "out_of_likes", "age_restricted", "", "limit_of_likes", "phone_verify_required"]
  ...
  create_table "tinder_accounts", force: :cascade do |t|
    ...
    t.boolean "warm_up", default: false, null: false
    t.decimal "geo_proxy_latitude"
    t.decimal "geo_proxy_longitude"
